 ...
 */
final class Version20190730124857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, director_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, poster VARCHAR(255) NOT NULL, release_at DATETIME NOT NULL, synopsis LONGTEXT NOT NULL, INDEX IDX_1D5EF26F899FB366 (director_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, movie_id INT DEFAULT NULL, author_id INT DEFAULT NULL, created_at DATETIME NOT NULL, comment LONGTEXT NOT NULL, notation INT NOT NULL, INDEX IDX_D88926228F93B6FC (movie_id), INDEX IDX_D8892622F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
